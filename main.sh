...
# cat $datadir/docs/{?,??}.doc > $datadir/docs/genome.doc

python /home/garner1/Work/pipelines/refgenomeLP/build_vocabulary.py $datadir/docs/genome.doc
mv $datadir/docs/genome.doc.vocabulary.p $datadir/pickle_vocabularies

# parallel --memfree 30G "python /home/garner1/Work/pipelines/refgenomeLP/vectorization.py {}" ::: /home/garner1/Work/dataset/refgenomeLP/XZ*/docs/genome.doc # process genome all together
# parallel --memfree 30G "python /home/garner1/Work/pipelines/refgenomeLP/vectorization.py {}" ::: $datadir/docs/*.doc # process chromosomes separately
